export default function HomePage() {
  return (
    <section>
      ...
      <p>
        MVP web per gli autotrasportatori. Include homepage, autenticazione di base con email e password e pagine di
      ...
      <ul>
        ...
        <li>Pagina di registrazione con invio dati a un endpoint API.</li>
