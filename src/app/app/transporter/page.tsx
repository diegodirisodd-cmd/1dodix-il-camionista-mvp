    ...
    <section className="space-y-6">
      <div className="card space-y-3">
        ...
        <div className="grid gap-4 md:grid-cols-3">
          ...
          <div className="rounded-lg border border-[#e2e8f0] bg-white p-5 shadow-sm">
            <p className="text-sm font-semibold text-[#0f172a]">Commissione 2% per richiesta</p>
            <p className="mt-2 text-sm leading-relaxed text-[#475569]">
              Sblocca i contatti aziendali solo quando serve, senza abbonamenti fissi.
            </p>
            <Link
      ...
      <div className="card space-y-2">
        ...
        <p className="text-xs text-[#64748b]">
          Puoi esplorare le richieste, ma i contatti restano protetti finché non li sblocchi.
        </p>
      </div>
    </section>
  );
