...
INSERT INTO "new_Request" ("cargo", "companyId", "contactsUnlocked", "createdAt", "delivery", "description", "id", "pickup", "price", "transporterId") SELECT "cargo", "companyId", "contactsUnlocked", "createdAt", "delivery", "description", "id", "pickup", "price", "transporterId" FROM "Request";
DROP TABLE "Request";
